...
uint16_t MCP3202::readADC(uint8_t channel)
{
  //see page 15 of datasheet: https://www.mouser.com/datasheet/2/268/21034c-69338.pdf
  char buff[3] = {0};
  
  buff[0] = 0x01;
  buff[1] = channel << 6 | 0x1 << 5; //MSB First
